...
import { FormDataRegister } from '@/services/auth/auth.types'
...
const RegisterForm: FC = () => {
  ...
  const { mutate } = useMutation({
    ...
    mutationFn: (data: FormDataRegister) => authService.register(data),
    onSuccess(data) {
  ...
  const onSubmit = (values: FormDataRegister) => {
    mutate(values)
  }
